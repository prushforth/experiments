    ...
    'https://tiles.arcgis.com/tiles/HsjBaDykC1mjhXz9/arcgis/rest/services/CBMT_CBCT_3857_V_OSM/VectorTileServer/tile/{z}/{y}/{x}.pbf',
    {
        ...
        rules: {
            PAINT_RULES: [
                ...
                {
                    dataLayer: 'Permanent Snow and Ice/(4-9)',
                    symbolizer: new protomapsL.PolygonSymbolizer({ fill: 'undefined' }),
                    minZoom: 4,
                    maxZoom: 9
                },
                ...
                // Layer 190: Man-made Features/Dam/(12-24)/Line/4
                {
                    ...
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#FFFFFF', width: 2.5196833333333335 }),
                    minZoom: 12,
                    maxZoom: 22
                },
                ...
                {
                    dataLayer: 'Dam/(12-24)/Line',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#828282', width: 0.6299199999999999 }),
                    minZoom: 12,
                    maxZoom: 22
                },
                ...
                // Layer 210: Resource Management Features/Pipeline/(9-24)/Aboveground/1
                {
                    ...
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#999999', width: 4.000003333333333 }),
                    minZoom: 9,
                    maxZoom: 22,
                    filter: (z, f) => f.props._symbol === 1
                },
                ...
                {
                    dataLayer: 'Pipeline/(9-24)',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#FFFFFF', width: 2.3225833333333337 }),
                    minZoom: 9,
                    maxZoom: 22,
                    filter: (z, f) => f.props._symbol === 1
                },
                ...
                {
                    dataLayer: 'Pipeline/(9-24)',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#CCCCCC', width: 4.000003333333333 }),
                    minZoom: 9,
                    maxZoom: 22,
                    filter: (z, f) => f.props._symbol === 0
                },
                ...
                {
                    dataLayer: 'Road Segment/(9-15)/Road',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#F2B600', width: 0.9999985 }),
                    minZoom: 9,
                    maxZoom: 15,
                ...
                {
                    dataLayer: 'Road Segment/(9-15)/Road',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#F2C749', width: 1.066665 }),
                    minZoom: 9,
                    maxZoom: 15,
                ...
                {
                    dataLayer: 'Road Segment/(9-15)/Road',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#D9A300', width: 2.1 }),
                    minZoom: 9,
                    maxZoom: 15,
                    filter: (z, f) => f.props._symbol === 1
                },
                ...
                {
                    dataLayer: 'Road Segment/(9-15)/Tunnel',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#F2C749', width: 1.5333350000000001 }),
                    minZoom: 9,
                    maxZoom: 15,
                    filter: (z, f) => f.props._symbol === 5
                },
                ...
                {
                    dataLayer: 'Road Segment/(9-15)/Tunnel',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#D9A300', width: 3.1111533333333328 }),
                    minZoom: 9,
                    maxZoom: 15,
                    filter: (z, f) => f.props._symbol === 0
                },
                ...
                {
                    dataLayer: 'Road Segment/(9-15)/Tunnel',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#666666', width: 1.55548 }),
                    minZoom: 9,
                    maxZoom: 15,
                    filter: (z, f) => f.props._symbol === 0
                },
                ...
                {
                    dataLayer: 'Road Segment/(9-15)/Tunnel',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#666666', width: 0.9 }),
                    minZoom: 9,
                    maxZoom: 15,
                    filter: (z, f) => f.props._symbol === 1
                },
                ...
                {
                    dataLayer: 'Road Segment/(9-15)/Tunnel',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#F2B600', width: 2.8666650000000002 }),
                    minZoom: 9,
                    maxZoom: 15,
                    filter: (z, f) => f.props._symbol === 2
                },
                ...
                {
                    dataLayer: 'Road Segment/(9-15)/Tunnel',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#666666', width: 0.6515150000000001 }),
                    minZoom: 9,
                    maxZoom: 15,
                    filter: (z, f) => f.props._symbol === 2
                },
                ...
                {
                    dataLayer: 'Road Segment/(9-15)/Tunnel',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#666666', width: 0.75 }),
                    minZoom: 9,
                    maxZoom: 15,
                    filter: (z, f) => f.props._symbol === 3
                },
                ...
                {
                    dataLayer: 'Road Segment/(9-15)/Tunnel',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#666666', width: 0.6764705 }),
                    minZoom: 9,
                    maxZoom: 15,
                    filter: (z, f) => f.props._symbol === 5
                },
                ...
                {
                    dataLayer: 'Road Segment/(9-15)/Tunnel',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#666666', width: 12 }),
                    minZoom: 9,
                    maxZoom: 15,
                    filter: (z, f) => f.props._symbol === 6
                },
                ...
                {
                    dataLayer: 'Road Segment/(15-24)/Road',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#F2C749', width: 0.9999985 }),
                    minZoom: 15,
                    maxZoom: 22,
                    filter: (z, f) => f.props._symbol === 6
                },
                ...
                {
                    dataLayer: 'Road Segment/(15-24)/Road',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#F2B500', width: 0.9999985 }),
                    minZoom: 15,
                    maxZoom: 22,
                    filter: (z, f) => f.props._symbol === 3
                },
                ...
                {
                    dataLayer: 'Road Segment/(15-24)/Road',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#F2C749', width: 1.2333335 }),
                    minZoom: 15,
                    maxZoom: 22,
                    filter: (z, f) => f.props._symbol === 4
                },
                ...
                {
                    dataLayer: 'Road Segment/(15-24)/Road',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#F2B500', width: 1.7999999999999998 }),
                    minZoom: 15,
                    maxZoom: 22,
                    filter: (z, f) => f.props._symbol === 2
                },
                ...
                {
                    dataLayer: 'Road Segment/(15-24)/Road',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#F2B600', width: 3.6000025 }),
                    minZoom: 15,
                    maxZoom: 22,
                    filter: (z, f) => f.props._symbol === 1
                },
                ...
                {
                    dataLayer: 'Road Segment/(15-24)/Road',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#D9A200', width: 9.333356666666667 }),
                    minZoom: 15,
                    maxZoom: 22,
                    filter: (z, f) => f.props._symbol === 0
                },
                ...
                {
                    dataLayer: 'Road Segment/(15-24)/Road',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#F8F7F2', width: 4.666663333333333 }),
                    minZoom: 15,
                    maxZoom: 22,
                    filter: (z, f) => f.props._symbol === 0
                },
                ...
                {
                    dataLayer: 'Road Segment/(15-24)/Tunnel',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#666666', width: 0.5454545 }),
                    minZoom: 15,
                    maxZoom: 22,
                    filter: (z, f) => f.props._symbol === 1
                },
                ...
                {
                    dataLayer: 'Road Segment/(15-24)/Tunnel',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#666666', width: 0.875 }),
                    minZoom: 15,
                    maxZoom: 22,
                    filter: (z, f) => f.props._symbol === 0
                },
                ...
                {
                    dataLayer: 'Road Segment/(15-24)/Tunnel',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#666666', width: 0.7941175 }),
                    minZoom: 15,
                    maxZoom: 22,
                    filter: (z, f) => f.props._symbol === 2
                },
                ...
                {
                    dataLayer: 'Road Segment/(15-24)/Tunnel',
                    symbolizer: new protomapsL.LineSymbolizer({ color: '#666666', width: 0.54411775 }),
                    minZoom: 15,
                    maxZoom: 22,
                    filter: (z, f) => f.props._symbol === 4
                },
            ...
            LABEL_RULES: [
                ...
                // Layer 464: Toponymic Features/Named Feature/Island/Polygon/label/5 FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.73333,
                            font: 'Aboriginal Sans Regular 12.66665px'
                        }),
                    minZoom: 7,
                    maxZoom: 11,
                ...
                // Layer 468: Toponymic Features/Named Feature/Island/Polygon/label/3 FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.73333,
                            font: 'Aboriginal Sans Regular 14.66665px'
                        }),
                    minZoom: 7,
                    maxZoom: 11,
                ...
                // Layer 472: Toponymic Features/Named Feature/Island/Polygon/label/1 FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.73333,
                            font: 'Aboriginal Sans Regular 22.66665px'
                        }),
                    minZoom: 7,
                    maxZoom: 11,
                ...
                // Layer 544: Toponymic Features/Named Feature/Places/(5-18)/label/23-35 FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.73333,
                            font: 'Aboriginal Sans Regular 12.476185714285716px'
                        }),
                    minZoom: 5,
                    maxZoom: 18,
                ...
                // Layer 546: Toponymic Features/Named Feature/Places/(5-18)/label/21-22 FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.73333,
                            font: 'Aboriginal Sans Regular 12.740744444444445px'
                        }),
                    minZoom: 5,
                    maxZoom: 18,
                ...
                // Layer 548: Toponymic Features/Named Feature/Places/(5-18)/label/36 FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.86667,
                            font: 'Aboriginal Sans Regular 13.999987499999998px'
                        }),
                    minZoom: 5,
                    maxZoom: 18,
                ...
                // Layer 550: Toponymic Features/Named Feature/Places/(5-18)/label/18-20 FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.86667,
                            font: 'Aboriginal Sans Regular 13.111088888888888px'
                        }),
                    minZoom: 5,
                    maxZoom: 18,
                ...
                // Layer 552: Toponymic Features/Named Feature/Places/(5-18)/label/15-17 FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.86667,
                            font: 'Aboriginal Sans Regular 13.259244444444443px'
                        }),
                    minZoom: 5,
                    maxZoom: 18,
                ...
                // Layer 554: Toponymic Features/Named Feature/Places/(5-18)/label/14 FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.86667,
                            font: 'Aboriginal Sans Regular 13.62961111111111px'
                        }),
                    minZoom: 5,
                    maxZoom: 18,
                ...
                // Layer 562: Transport Features/Road Segment/(9-15)/Road/label/Collectionneur FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.86667,
                            font: 'Aboriginal Sans Regular 13.33335px'
                        }),
                    minZoom: 11,
                    maxZoom: 15,
                    filter: (z, f) => f.props._label_class === 7
                ...
                // Layer 568: Transport Features/Road Segment/(9-15)/Road/label/Local FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 2,
                            font: 'Aboriginal Sans Regular 11.33335px'
                        }),
                    minZoom: 13,
                    maxZoom: 15,
                    filter: (z, f) => f.props._label_class === 8
                ...
                // Layer 578: Transport Features/Road Segment/(9-15)/Road/label/Autoroute nommée FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 2.66667,
                            font: 'Aboriginal Sans Italic 15.33335px'
                        }),
                    minZoom: 9,
                    maxZoom: 15,
                    filter: (z, f) => f.props._label_class === 5
                ...
                // Layer 586: Transport Features/Road Segment/(15-24)/Road/label/Route Number
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#FFF',
                            haloWidth: 1,
                            font: 'Aboriginal Sans Bold 10.222243333333333px'
                        }),
                    minZoom: 15,
                    maxZoom: 22
                },
                ...
                // Layer 587: Toponymic Features/Named Feature/Places/(5-18)/label/13 FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.86667,
                            font: 'Aboriginal Sans Regular 13.777766666666668px'
                        }),
                    minZoom: 5,
                    maxZoom: 18,
                ...
                // Layer 589: Toponymic Features/Named Feature/Places/(5-18)/label/12 FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.86667,
                            font: 'Aboriginal Sans Regular 13.833325px'
                        }),
                    minZoom: 5,
                    maxZoom: 18,
                ...
                // Layer 591: Toponymic Features/Named Feature/Places/(5-18)/label/9-11 FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.86667,
                            font: 'Aboriginal Sans Regular 14.296299999999999px'
                        }),
                    minZoom: 5,
                    maxZoom: 18,
                ...
                // Layer 593: Toponymic Features/Named Feature/Places/(5-18)/label/8 FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.86667,
                            font: 'Aboriginal Sans Regular 14.51851111111111px'
                        }),
                    minZoom: 5,
                    maxZoom: 18,
                ...
                // Layer 595: Toponymic Features/Named Feature/Places/(5-18)/label/7 FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.86667,
                            font: 'Aboriginal Sans Regular 14.666674999999998px'
                        }),
                    minZoom: 5,
                    maxZoom: 18,
                ...
                // Layer 597: Toponymic Features/Named Feature/Places/(5-18)/label/6 FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.86667,
                            font: 'Aboriginal Sans Regular 14.22223333333333px'
                        }),
                    minZoom: 5,
                    maxZoom: 18,
                ...
                // Layer 599: Toponymic Features/Named Feature/Places/(5-18)/label/5 FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.86667,
                            font: 'Aboriginal Sans Regular 14.666633333333332px'
                        }),
                    minZoom: 5,
                    maxZoom: 18,
                ...
                // Layer 601: Toponymic Features/Named Feature/Places/(5-18)/label/4 FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.86667,
                            font: 'Aboriginal Sans Regular 15.1111px'
                        }),
                    minZoom: 5,
                    maxZoom: 18,
                ...
                // Layer 603: Toponymic Features/Named Feature/Places/(5-18)/label/3 FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.86667,
                            font: 'Aboriginal Sans Regular 14.952385714285713px'
                        }),
                    minZoom: 5,
                    maxZoom: 18,
                ...
                // Layer 619: Toponymic Features/Atlas Named Feature/Hydro Features/label/XXL FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.73333,
                            font: 'Aboriginal Serif Italic 14px'
                        }),
                    minZoom: 7,
                    maxZoom: 10,
                    filter: (z, f) => f.props._label_class === 9
                ...
                // Layer 669: Toponymic Features/Atlas Named Feature/Provinces and International/(2-7)/label/Provinces (3-5) FR
                {
                    ...
                    symbolizer: new protomapsL.CenteredTextSymbolizer({
                            ...
                            halo: '#F8F7F2',
                            haloWidth: 1.6,
                            font: 'Aboriginal Sans Regular 11.6667px'
                        }),
                    minZoom: 2,
                    maxZoom: 4,
                    filter: (z, f) => f.props._label_class3 === 3
